...
const worksArray = [
  ...
  },
  {
    ...
    otherImg: [
      ...
      "/img/works/snsapp/snsapp4.png",
      "/img/works/snsapp/snsapp5.png",
      "/img/works/snsapp/snsapp6.png",
    ],
    lang: "HTML/CSS, Javascript, React, Node.js, express, mongoose, mongoDB",
  },
  {
    ...
    name: "ポートフォリオサイト",
    content:
      "このWebページです。Next.jsを使用し、自身のことについて知ってもらえるようなページを作成しました。プログラミング言語のロゴやworksは画面上に入ったことを検知し、アニメーション付与させるようにしました。今後も学んだ技術や知識試す場所として運用、活用していこうと考えています。",
    img: "/img/works/portfolio/portfolio1.png",
    otherImg: [
      "/img/works/portfolio/portfolio1.png",
      "/img/works/portfolio/portfolio2.png",
      "/img/works/portfolio/portfolio3.png",
      "/img/works/portfolio/portfolio4.png",
    ],
    lang: "HTML/CSS, Javascript, Next.js, Node.js, express, mongoose, mongoDB",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    name: "And More",
    content:
      "その他にもNext.js, Node.js, React, Prisma, Supabaseを使用した簡単なSNSアプリや学習書などを通して様々なサンプルサイトなどを作成してきました。",
    ...
    otherImg: [
      ...
      "/img/works/andmore/noteapp.png",
      "/img/works/andmore/todoapp.png",
    ],
